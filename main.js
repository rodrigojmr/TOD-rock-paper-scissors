...
function computerPlay() {
  ...
  if (rand === 0) {
    document.getElementById('computer-hand').src = 'Rock.svg';
    return "Rock"
  } else if (rand === 1) {
    document.getElementById('computer-hand').src = 'Paper.svg';
    return "Paper"
  }
  else if (rand === 2) {
    document.getElementById('computer-hand').src = 'Scissors.svg';
    return "Scissors"
  }
}
